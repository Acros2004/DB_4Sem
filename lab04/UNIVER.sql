...
insert into FACULTY   (FACULTY,   FACULTY_NAME )
            values  ('ИДиП',     'Издательского Дела и	Полиграфии');			
...
create table PROFESSION
 ...
 insert into PROFESSION(FACULTY, PROFESSION,  PROFESSION_NAME, QUALIFICATION)    values    ('ИТ',  '1-36 06 01',  'Полиграфическое оборудование и систе-мы обработки информации', 'инженер-электромеханик' );                     
